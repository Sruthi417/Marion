...
const Cart = () => {
  ...
  return (
    <>
      ...
      <div
        className={isCartOpen ? "cart-overlay active" : "cart-overlay"}
        onClick={closeCart}
      />

      {/* DRAWER */}

      <div className={isCartOpen ? "cart-sidebar active" : "cart-sidebar"}>
        {/* TOP */}
                ...
                <div className="cart-item-info">
                  <div className="cart-item-top">
                    <div>
                      ...
                      <div className="cart-item-size">{item.size || "S"}</div>
                    </div>
                  ...
                  <div className="cart-item-actions">
                    <div className="quantity-controls">
                      <button
                        onClick={() =>
                          decrementCount(item.product_id, item.size)
                        }
                      >
                        −
                      </button>
                      ...
                      <button
                        onClick={() =>
                          incrementCount(item.product_id, item.size)
                        }
                      >
                        +
                      </button>
